...
public class SaveNewBookAsyncTask extends AsyncTask<Book, Void, Boolean>{
...
//			Log.d("test",qb.buildSaveURL("Book"));
	        HttpPost request = new HttpPost(qb.buildSaveURL("Book"));
//	        Log.d("test",qb.createBookInDB(book));
//	        book.print();
	        StringEntity se =new StringEntity(qb.createBookInDB(book));
//	        Log.d("test","testing1");
...
//	        Log.d("test","testing4");
	        ...
	        {	        
	        	Log.d("test","response.getStatusLine().getStatusCode()");
	        	return true;
	        }
	        else
	        {
